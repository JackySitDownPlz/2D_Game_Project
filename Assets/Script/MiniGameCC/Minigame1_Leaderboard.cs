...
public class Minigame1_Leaderboard : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        if (Minigame1_PlayerController.endGame == true)
        {
            ...
            if (scoreTexts[0].text == scoreTexts[1].text && scoreTexts[0].text == scoreTexts[3].text && scoreTexts[0].text == scoreTexts[4].text)
            {
            ...
            else if(scoreTexts[0].text == scoreTexts[1].text && scoreTexts[0].text == scoreTexts[3].text)
            {
                winnerName = nameTexts[0].text;
                swinnerName = nameTexts[1].text;
                twinnerName = nameTexts[2].text;
